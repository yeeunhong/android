...
public class ParsingEngine12124 {
	private Context context;
	private InputStream in = null;
	private Element root;
	
	public ParsingEngine12124( Context context, String paramString ) throws Exception {
	...
	private void parsing(String paramString) throws Exception {
		...
		try
		{
			in = context.getResources().getAssets().open("st14111.txt");
